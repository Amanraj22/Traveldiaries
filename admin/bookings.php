...
<section class="bookings">
   ...
   <?php
    ...
    if($numExistRows > 0){
        foreach($result as $row){
            ...
            echo ' <input type="submit" value="cancel booking" name="cancel" class="btn" onclick="return confirm(\'cancel this booking?\');">';
            echo '</form>
            </div>';
        }
    }
   ...
   echo ' <a href="packcrud/package.php" class="btn">book new</a>';
   echo '</div>';
}
?>
   </div>
